...
export const NPCS = [
  ...
  },
  {
    ...
    nodes: {
      ...
      tips: {
        text: 'Vを長押しすると盾で正面のダメージを7割カットできる。ただしガード不能の強打は避けるしかない。Spaceで回避ローリングよ。',
...
export const QUESTS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { kind: 'action', action: 'heal', label: '回復してみよう！ Cで回復' },
      { kind: 'action', action: 'block', label: '盾を使ってみよう！ Vを長押し' },
    ],
